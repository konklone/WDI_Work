...
describe Calculator do
  ...
  describe "#sum" do
    ...
    it "computes the sum of an array of two numbers" do
      expect(Calculator.new.sum([2, 3])).to eq(5)
    end

    it "computes the sum of an array of many numbers" do
      expect(Calculator.new.sum([2, 2, 3])).to eq(7)
    end
...
# Once the above tests pass, fill in the tests and code for the following:
  ...
  describe "#multiply" do
    ...
    it "multiplies several numbers" do
      expect(Calculator.new.multiply(2, 2, 5)).to eq(20)
    end
  ...
  describe "#factorial" do
    ...
    it "computes the factorial of 5" do
      expect(Calculator.new.factorial(5)).to eq(120)# 120
    end
    it "computes the factorial of 10" do
      expect(Calculator.new.factorial(10)).to eq(3628800)# 3628800
    end
  end
