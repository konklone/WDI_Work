...
describe Calculator do
  ...
  describe "#sum" do
    it "computes the sum of an empty array" do
      expect(Calculator.new.sum([0])).to eq(0)
    end
    ...
    it "computes the sum of an array of many numbers" do
      expect(Calculator.new.sum([2,4,2,4])).to eq(12)
    end
...
# Once the above tests pass, fill in the tests and code for the following:
  ...
  describe "#multiply" do
    ...
    it "multiplies several numbers" do
      expect(Calculator.new.multiply(2,3,4)).to eq(24)
    end

    it "multiplies two numbers where one of them is 0" do
      expect(Calculator.new.multiply(5,0)).to eq(0)
    end
