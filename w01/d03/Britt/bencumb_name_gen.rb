...
# Combine 1 name from firstnamelist and 1 from lastnamelist to form a name
puts "each time you press return, I'll give you another dose of the magic."
puts "to exit, type 'q'"
puts "get ready..."
puts "go."
...
while user_input != "q"
	print "#{firstnamelist.sample} #{lastnamelist.sample} "
