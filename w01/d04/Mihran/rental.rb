...
newguy = Person.new(name, age, gender, apartment)   ###newguy  ???
...
# puts "What's the person's age?"
# age = gets.chomp.to_i
# puts "What's the person's gender? m or f?"
# gender = gets.chomp.downcase
# puts "What's the person's apartment number?"
# apartment = gets.chomp.to_i
# person.initialize (name, age, gender, apartment)
