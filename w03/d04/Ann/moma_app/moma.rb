...
vincent.save 
pablo = Artist.new(name:"Pablo Picasso", nationality: "Spain", date_of_birth: "1881-10-25")
pablo.save 
...
eternity.save 
starry = Painting.new(title:"Starry Night", year: "1889", image_url:"http://atomictoasters.com/wp-content/gallery/professors-shutdown-images/starry-night.jpg", artist_id: 1)
starry.save 
